module.exports = {
    ...
    skills: {
      header: 'Skills and Expertise',
      skills: [
        {skill: 'skill1',priority: 0},
        {skill: 'skill2',priority: 0},
        {skill: 'python',priority: 0},
        {skill: 45,priority: 0},
        {skill: 'Mongodb',priority: 0},
        {skill: 'comedy',priority: 0},
        {skill: 'textwrap case testing',priority: 0},
        {skill: 'eating',priority: 0},
        {skill: 'drinking',priority: 0},
        {skill: 'breathing',priority: 0} ,
